...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideCategoryRepository(dao: CategoryDao, firestore: FirebaseFirestore): CategoryRepository {
        return CategoryRepository(dao, firestore)
    }
    ...
    fun provideChatRepository(
        ...
        @ApplicationContext context: Context): ChatRepository {
        return ChatRepository(chatDao, budgetDao, firestore, context)
    }
