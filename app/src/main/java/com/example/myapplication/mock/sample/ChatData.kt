...
/**
 * ChatData: Datos de prueba para sistema de chat con conversaciones y mensajes de ejemplo,
 * incluye historial de mensajes con timestamps, imágenes, ubicaciones y citas.
 */
