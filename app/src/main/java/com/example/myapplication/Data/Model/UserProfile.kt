...
data class UserProfile(
    ...
    val phoneNumber: String = "",// N├║mero de tel├®fono
    val address: String = "",// Direcci├│n
    val addressHome: String = "",// Direcci├│n de casa
    val addressWork: String = "",// Direcci├│n de trabajo
    val cityHome: String = "",// Ciudad de casa
    val stateHome: String = "",// Provincia de casa
    val zipCodeHome: String = "",// C├│digo postal de casa
    val cityWork: String = "",// Ciudad de trabajo
    val stateWork: String = "",// Provincia de trabajo
    val zipCodeWork: String = "",// C├│digo postal de trabajo
    val city: String = "",// Ciudad
    val state: String = "",// Provincia
    val zipCode: String = "",// C├│digo postal
