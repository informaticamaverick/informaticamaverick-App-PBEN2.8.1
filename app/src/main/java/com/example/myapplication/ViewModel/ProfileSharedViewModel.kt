...
/**
 * ProfileSharedViewModel: ViewModel compartido que sincroniza estado de usuario (Cliente/Empresa),
 * datos de perfil con Room y actúa como fuente única de verdad para todas las pantallas.
 */
