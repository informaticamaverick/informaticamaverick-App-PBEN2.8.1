...
// Nota: Asegúrate de tener importados los modelos de Budget, Calendar y Chats (BudgetItem, EventType, etc.)
...
class Converters {
    ...
    // Sirve para: emails adicionales, fotos de galería, IDs de imágenes del presupuesto, categorías.
    // ==========================================
    @TypeConverter
    ...
    // ==========================================
    // 4. MODELOS DE PRESUPUESTO (BudgetEntity)
    // ==========================================
    ...
    // ==========================================
    // 5. MODELOS DE CHATS (MessageEntity)
    // ==========================================
    @TypeConverter
