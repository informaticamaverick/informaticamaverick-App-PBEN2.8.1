...
object ConversacionesMock {
    ...
    private fun conversacionMariaGonzalez() = listOf(
        Message(
            ...
            text = "Hola! Necesito agendar mi sesión mensual 😊",
        ...
        Message(
            ...
            appointmentTitle = "Sesión de corte y color",
    ...
    private fun conversacionCarlosRodriguez() = listOf(
        ...
        Message(
            ...
            isFromCurrentUser = true,
            type = Message.MessageType.APPOINTMENT,
            appointmentTitle = "Corte de cabello",
    ...
    private fun conversacionAnaLopez() = listOf(
        ...
        Message(
            ...
            isFromCurrentUser = true,
            type = Message.MessageType.APPOINTMENT,
            appointmentTitle = "Tratamiento capilar",
    ...
    private fun conversacionJuanPerez() = listOf(
        Message(
            id = UUID.randomUUID().toString(),
            text = "Buenas! Cuánto sale el corte?",
        ...
        Message(
            id = UUID.randomUUID().toString(),
            text = "Hola Juan! El corte clásico sale $8000. Incluye lavado y terminado.",
        ...
        Message(
            id = UUID.randomUUID().toString(),
            text = "Te propongo corte y barba para el 27 de febrero a las 11:30",
            timestamp = System.currentTimeMillis() - 1400000,
            isFromCurrentUser = true,
            type = Message.MessageType.APPOINTMENT,
            appointmentTitle = "Corte y barba",
    ...
    private fun conversacionLauraMartinez() = listOf(
        ...
        Message(
            id = UUID.randomUUID().toString(),
            text = "Quiero cambiar de look!! 💇‍♀️💁‍♀️",
        ...
        Message(
            id = UUID.randomUUID().toString(),
            text = "Hola Laura! 😊 Genial! ¿Qué tenías en mente?",
        ...
        Message(
            id = UUID.randomUUID().toString(),
            text = "Quiero un cambio radical, me animé a teñirme de rubio 🤩",
        ...
        Message(
            id = UUID.randomUUID().toString(),
            text = "Me encanta! Vamos a necesitar al menos 3 horas. Te propongo el sábado:",
        ...
        Message(
            ...
            isFromCurrentUser = true,
            type = Message.MessageType.APPOINTMENT,
            appointmentTitle = "Decoloración + Tinte completo",
            appointmentDate = "2026-02-22",
            appointmentTime = "10:00",
    ...
    private fun conversacionValeriaSanchez() = listOf(
        ...
        Message(
            id = UUID.randomUUID().toString(),
            text = "Necesito un corte y alisado para un evento. Sería para la próxima semana",
    ...
    private fun conversacionSofiaRomero() = listOf(
        ...
        Message(
            ...
            isFromCurrentUser = true,
            type = Message.MessageType.APPOINTMENT,
            appointmentTitle = "Mantenimiento de color",
